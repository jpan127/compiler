...
void PascalToken::initialize()
{
    ...
    /// Dont feel like messing with the vectors ugh
    RESERVED_WORDS["WHEN"]      = PascalTokenType::WHEN;
    RESERVED_WORDS["OTHERWISE"] = PascalTokenType::OTHERWISE;
    ...
    SPECIAL_SYMBOLS["=>"] = PascalTokenType::ALLOW;
    SPECIAL_SYMBOL_NAMES[PascalTokenType::ALLOW] = "ALLOW";
