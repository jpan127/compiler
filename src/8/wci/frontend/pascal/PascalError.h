...
enum class PascalErrorCode
{
    ...
    MISSING_ALLOW,
    MISSING_OTHERWISE,
    WHEN_LHS_SHOULD_BE_CONDITION,
    WHEN_RHS_SHOULD_BE_ASSIGNMENT,
    WHEN_SKIPPING_STATEMENT,
};
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
constexpr PascalErrorCode MISSING_WHEN                  = PascalErrorCode::MISSING_WHEN;
constexpr PascalErrorCode MISSING_ALLOW                 = PascalErrorCode::MISSING_ALLOW;
constexpr PascalErrorCode MISSING_OTHERWISE             = PascalErrorCode::MISSING_OTHERWISE;
constexpr PascalErrorCode WHEN_LHS_SHOULD_BE_CONDITION  = PascalErrorCode::WHEN_LHS_SHOULD_BE_CONDITION;
constexpr PascalErrorCode WHEN_RHS_SHOULD_BE_ASSIGNMENT = PascalErrorCode::WHEN_RHS_SHOULD_BE_ASSIGNMENT;
constexpr PascalErrorCode WHEN_SKIPPING_STATEMENT       = PascalErrorCode::WHEN_SKIPPING_STATEMENT;
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
