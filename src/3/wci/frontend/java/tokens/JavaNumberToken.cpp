...
namespace wci::frontend::java::tokens
{
    ...
    JavaNumberToken::JavaNumberToken(Source *source) : JavaToken(source)
    {
        extract();
    }
    ...
    void JavaNumberToken::extract()
    {
        ...
        type = (TokenType) JavaTokenType::token_integer;

        // Extract the digits of the whole part of the number.
        whole_digits = unsigned_integer_digits();

        if (type == (TokenType) JavaTokenType::token_error) return;
        ...
        if (current_ch == '.')
        {
            ...
            else
            {
                ...
                type = (TokenType) JavaTokenType::token_fpoint;
                text += current_ch;
                ...
                if (type == (TokenType) JavaTokenType::token_error)
                {
                    return;
                }
            }
        ...
        if (type == (TokenType) JavaTokenType::token_integer)
        {
        ...
        else if (type == (TokenType) JavaTokenType::token_fpoint)
        {
     ...
     * @throws Exception if an error occurred.
     */
    string JavaNumberToken::unsigned_integer_digits()
    {
        ...
        if (!isdigit(current_ch))
        {
            ...
            value = (int) JavaErrorCode::INVALID_NUMBER;
            return "";
        }
    ...
    int JavaNumberToken::compute_integer_value(string digits)
    {
        ...
        // Overflow:  Set the integer out of range error.
            ...
            type = (TokenType) JavaTokenType::token_error;
            value = (int) JavaErrorCode::RANGE_INTEGER;
            return 0;
        }
    }
                                                 ...
                                                 char exponent_sign)
    {
        ...
        {
            type = (TokenType) JavaTokenType::token_error;
            value = (int) JavaErrorCode::RANGE_REAL;
            return 0.0f;
        }
