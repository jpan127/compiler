...
public:
     ...
     */
    bool get_attribute(const IntermediateCodeNodeAttribute attribute, data_S & data) const;
     ...
     */
    void set_attribute(const IntermediateCodeNodeAttribute attribute, const data_S & data);
...
private:
    ...
    map <const IntermediateCodeNodeAttribute, const data_S> attributes;
